...
**Status:** built. Build order steps 1–9 are done — schema, every Section 9 screen, licence delivery with browser-side signing, new customer through cPanel UAPI, subscriptions, health, removal, the panel's own backup and deploy. Step 10 is Soran's to run: his own shop first, then Halabja-phone rebuilt through the panel.
